# nomad-measurements-sweepme

NOMAD plugin for SweepMe measurement data integration
...
```sh
git clone https://github.com/glaidedata/nomad-measurements-sweepme.git
cd nomad-measurements-sweepme
